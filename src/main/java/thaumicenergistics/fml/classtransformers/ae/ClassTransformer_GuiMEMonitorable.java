...
public class ClassTransformer_GuiMEMonitorable
	extends AClassTransformer
{
	...
	private static void transformPostUpdate( final MethodNode method )
	{
		...
		instructionList.add( new MethodInsnNode( Opcodes.INVOKESTATIC, "thaumicenergistics/common/integration/AEHooks",
						"isItemGUIBlacklisted", "(Lappeng/api/storage/data/IAEItemStack;)Z",
						false ) );
